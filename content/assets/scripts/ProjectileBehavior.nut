/**
 * ProjectileBehavior is the base class for all scripted projectile behaviors. Extend this
 * class to create a new kind of behavior. This class provides an interface for
 * the game engine to communicate with a scripted projectile.
 */
class ProjectileBehavior {
    /**
     * A proxy object back to an Projectile instance in the game engine.
     * @type {Projectile}
     */
    host = null;
    ...
    /**
     * Attaches this behavior to an instance of an Projectile (the host). This can be
     * used to perform any additional logic required when a projectile is spawned.
     *
     * Projectiles can optionally be passed a table containing instance-level
     ...
     *
     * @param  {Projectile} newHost        an instance of Projectile to attach to
...
::log("ProjectileBehavior.nut executed!");